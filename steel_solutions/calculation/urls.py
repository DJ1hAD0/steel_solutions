...
urlpatterns = [
    ...
    path('create_pogonage_unit_entry', views.create_pogonage_unit_entry, name='create_pogonage_unit_entry'),
    path('update_pogonage_unit_entry', views.update_pogonage_unit_entry, name='update_pogonage_unit_entry'),
    path('delete_pogonage_unit_entry', views.delete_pogonage_unit_entry, name='delete_pogonage_unit_entry'),
